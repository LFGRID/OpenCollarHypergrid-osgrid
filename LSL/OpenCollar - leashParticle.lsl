...
SetTexture(string sIn, key kIn)
{
    ...
    if (sIn=="chain")
    {
        g_sParticleTextureID="eaedc5e9-7bb9-4396-a0e7-540f83a85da9";//OSgrid texture
    } 
    else if (sIn=="rope")
    {
        g_sParticleTextureID="c85cde15-130e-449b-bbb0-d21d0f9212f1";//OSgrid texture
    } 
    else if (sIn=="totallytransparent")
    {
        g_sParticleTextureID="1a2bcd61-c82c-4d73-aaa8-b5aabec615e4";//OSgrid texture
    } else {
