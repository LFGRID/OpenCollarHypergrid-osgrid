    ...
    link_message(integer iSender, integer iNum, string sStr, key kID)
    {
        ...
        else if (iNum >= COMMAND_OWNER && iNum <= COMMAND_WEARER)
        {
            ...
            {  //handle changing prefix and channel from owner
                ...
                {
                    if (sValue=="") 
                    {  //Just let them know their current name
        ...
        else if (iNum == POPUP_HELP)
        {
            ...
            //TODO: -- it compiles but there is a warning:
            //  Multiple assignments to 'sStr'; results may differ between LSL and OSSL
